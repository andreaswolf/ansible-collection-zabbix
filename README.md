# Ansible collection: `a9f.zabbix`

This repository contains the `a9f.zabbix` Ansible Collection.
...
This project was created and is maintained by Andreas Wolf.
